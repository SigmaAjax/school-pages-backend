...
const postDbPool = mysql.createPool({
	...
	host:
		process.env.NODE_ENV === 'production'
			? new URL(process.env.CLEARDB_DATABASE_URL).hostname
			: process.env.DB_HOST,
	user:
		process.env.NODE_ENV === 'production'
			? new URL(process.env.CLEARDB_DATABASE_URL).username
			: process.env.DB_USERNAME,
	password:
		process.env.NODE_ENV === 'production'
			? new URL(process.env.CLEARDB_DATABASE_URL).password
			: process.env.DB_PASSWORD,
	database: process.env.DB_DATABASE_POST,
	port:
		process.env.NODE_ENV === 'production'
			? new URL(process.env.CLEARDB_DATABASE_URL).port
			: process.env.DB_PORT,
